...
export default function Home() {
  ...
  return (
    <>
      <div className="container max-w-xl mx-auto pt-4 pb-6 md:pt-8 md:pb-10 lg:pt-10 lg:pb-16">
        <div className="mx-auto flex flex-col gap-4">
          ...
          <div className="flex w-full max-w-xl items-center space-x-2 mt-5">
            <input
              ref={inputRef}
          ...
          {!loading && answer.length > 0 && (
            <>
              <div className="rounded-md border-neutral-300 border p-5 mt-4">
                ...
                <h6 className="leading-normal text-slate-200 sm:leading-7 mt-3">
                  {answer}
                </h6>
              </div>
            </>
